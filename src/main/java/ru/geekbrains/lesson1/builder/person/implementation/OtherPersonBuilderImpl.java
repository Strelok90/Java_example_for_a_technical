package ru.geekbrains.lesson1.builder.person.implementation;

import ru.geekbrains.lesson1.builder.person.OtherPerson;
import ru.geekbrains.lesson1.builder.person.PersonBuilder;
import ru.geekbrains.lesson1.builder.person.genderType.Gender;
